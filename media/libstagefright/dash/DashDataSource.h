...
#ifndef DASH_DATA_SOURCE_H_
#define DASH_DATA_SOURCE_H_
...
struct DashDataSource : public DataSource {
    DashDataSource();
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(DashDataSource);
};

}  // namespace android

#endif  // DASH_DATA_SOURCE_H_
